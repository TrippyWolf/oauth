...
const identifier = '286775533293-vfiveqfoqoin3irq1eg77lv73ogdnbn3.apps.googleusercontent.com';

// This is a URL on your application's server. The authorization server
// will redirect the resource owner here once they've authorized the
// client. The redirection will include the authorization code in the
// query parameters.
final redirectUrl = Uri.parse('com.example.app%3A/oauth2redirect');

/// A file in which the users credentials are stored persistently. If the server
/// issues a refresh token allowing the client to refresh outdated credentials,
/// these may be valid indefinitely, meaning the user never has to
/// re-authenticate.
// final credentialsFile = File('~/.oauth/credentials.json');
...
Future<oauth2.Client> createClient() async {
  ...
  // into this method.
  var authorizationUrl = grant.getAuthorizationUrl(redirectUrl,scopes: ["profile"]);
